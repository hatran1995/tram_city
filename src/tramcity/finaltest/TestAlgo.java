...
public class TestAlgo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Start Test Algo Repartition Point");
		try (FileReader reader = new FileReader("C:\\Users\\H\\eclipse-workspace\\tramcity_project\\src\\tramcity\\finaltest\\TestAlgo.json"))
		{ 
			String fileContent= "";
			int i;    
...
//            	//random
				...
				if(  resListPoint.length() == testItem.getInt("output")) {
					...
					System.out.println("List Point : " + resListPoint.toString());
				}else {
					//test fail
