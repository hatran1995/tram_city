...
public class TestBudget {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		// test
		System.out.println("Start test valid budget");

		try (FileReader reader = new FileReader("C:\\Users\\H\\eclipse-workspace\\tramcity_project\\src\\tramcity\\finaltest\\TestBudget.json"))
		{ 
			String fileContent= "";
			int i;    
