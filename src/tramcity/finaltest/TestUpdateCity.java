...
public class TestUpdateCity {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		// test
		System.out.println("Start test update city");

		try (FileReader reader = new FileReader("C:\\Users\\H\\eclipse-workspace\\tramcity_project\\src\\tramcity\\finaltest\\TestUpdateCity.json"))
		{ 
			String fileContent= "";
			int i;    
