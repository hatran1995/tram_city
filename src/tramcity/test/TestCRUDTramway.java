...
import tramcity.server.common.*;
import tramcity.server.connection.DataSource;
public class TestCRUDTramway {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		// test
		System.out.println("Start test Tramway Network");

		try (FileReader reader = new FileReader("C:\\Users\\H\\eclipse-workspace\\tramcity_project\\src\\tramcity\\test\\tramway_create_update_data.json"))
		{ 
			String fileContent= "";
			int i;    
